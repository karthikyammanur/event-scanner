...
The table below updates automatically on every run. Contributions and issue
reports are welcome if you spot something miscategorized.

## Events

<!-- EVENTS:START -->

**79 current events.** Updated 2026-08-17 16:31 UTC.
...
| 2027 Data for Good Hackathon ⚑ | JPMorgan Chase | Hackathon | - | 14d | - | [Apply](https://career.soka.edu/jobs/jpmorganchase-2027-data-for-good-hackathon-data-ai-program-summer-internship) |
...
| Anthropic Fellows Program, The Anthropic Institute (Economics & Policy) ⚑ | Anthropic | Fellowship | London, UK; Ontario, CAN; Remote-Friendly, United States; San Francisco, CA | 3mo | - | [Apply](https://job-boards.greenhouse.io/anthropic/jobs/5183053008) |
...
| Research Fellowship - Open Endedness ⚑ | Vmax AI Corp | Fellowship | SF | 9mo | - | [Apply](https://jobs.ashbyhq.com/vmax/c4e1e51b-65c5-41f0-9bed-c90bc452859b) |
...
back after each run along with the README table above. That file is what
guarantees nothing is emailed twice, so avoid deleting it. It cannot be
gitignored: each scheduled run starts on a fresh machine with only the repo, so
the committed file is the only state that survives between runs.
